...
from app.services.professional_deliverables.drawing_quality_gates import (
    ...
    validate_pdf_concept_scope_text,
...
def generate_project_2d_bundle(
    ...
    *,
    ...
    gate_results = [
        ...
        validate_pdf_sheet_title_blocks(pdf_path, sheets),
        validate_pdf_concept_scope_text(pdf_path),
        ...
        validate_pdf_plan_viewport_usage(project),
        validate_pdf_room_label_non_overlap(project),
        validate_pdf_no_title_overlap(project),
        validate_pdf_page_render_nonblank(pdf_path),
        validate_pdf_elevation_layout(project),
        validate_dxf_sheet_parity(dxf_paths, sheets),
        validate_dxf_modelspace_nonempty(dxf_paths),
        validate_dxf_sheet_title_blocks(dxf_paths, sheets),
        ...
        validate_dxf_entity_richness(dxf_paths, sheets),
